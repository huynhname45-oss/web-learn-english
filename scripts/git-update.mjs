...
export async function git(home, args, report = () => {}, timeout = 30 * 60 * 1000) {
  return new Promise((done, reject) => {
    const child = spawn(gitExe(home), ['-c','credential.helper=','-c','core.autocrlf=false','-c','gc.auto=0','-c','maintenance.auto=false','-c','http.version=HTTP/1.1',`--git-dir=${gitDir(home)}`,...args], {
